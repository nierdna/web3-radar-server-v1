...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'ExtractCoinKeys': EventHandler<{ trigger?: string }, { topic: 'coins.keys.extracted'; data: { coinKey: string } }>
    ...
    'ExtractProjectsSteps': ApiRouteHandler<Record<string, unknown>, ApiResponse<200, { success: boolean; message: string; workflow: string }> | ApiResponse<500, { success: boolean; error: string }>, { topic: 'extraction.start'; data: { trigger?: string } }>
  }
}